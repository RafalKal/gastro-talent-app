...
const handleChange = (e) => {
  ...
  if (type === 'checkbox') {
    if (name === 'cookingStyles') {
      // Logika dla cookingStyles
      ...
      // Logika dla innych checkboxów (np. isVisible, isCertifiedSousChef)
      setFormData({ ...formData, [name]: checked });
    }
  } else {
    // Logika dla pozostałych pól (tekstowych, numerycznych, dat itd.)
